const projectsData = [
  {
    title: 'My practice environment for Web3 development',
    description: `The place where I create Solidity code to familiarize myself with the Ethereum platform.`,
    imgSrc: '/static/images/fot.png',
