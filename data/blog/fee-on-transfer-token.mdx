...
The FOT Token is integrating a transfer fee mechanism directly into the token's transfer process, it adds a new layer of
utility and potential for tokenomics. It's a demonstration of how smart contract
...
The FOT Token delegates transfer calls to another ERC20 token,
...
Visit the [GitHub repository](https://github.com/lyrx/fot) to learn more about the Fee-On-Transfer.
